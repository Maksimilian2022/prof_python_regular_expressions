...
pattern_duble1 = r'([А-Я][а-я]+(\s|,)[А-Я][а-я]+(\s|,)[А-Я][а-я]+,ФНС,cоветник отдела Интернет проектов Управления информационных технологий)(,+)'
...
pattern_duble2 = r'([А-Я][а-я]+(\s|,)[А-Я][а-я]+(\s|,)[А-Я][а-я]+),+(Минфин,+)(\+7\(495\)913-11-11)\s(доб\.0792)()'
...
pattern_del_str1 = r'([А-Я][а-я]+(\s|,)[А-Я][а-я]+,+Ivan.Laguntcov@minfin.ru,)'
substition_del1 = " "
str1 = re.findall(pattern_del_str1, new_text4)
new_text5 = re.sub(pattern_del_str1, substition_del1, new_text4)

pattern_del_str2 = r'([А-Я][а-я]+(\s|,)[А-Я][а-я]+(\s|,)[А-Я][а-я]+,ФНС,\+7\(495\)913-00-37)'
substition_del2 = ""
...
with open ("right_phonebook_raw.txt", 'w', encoding='utf8') as right_phonebook:
    right_phonebook.write(new_text6)
